...
static prop_t ml_props(prop_t arg, primitive *self, int type, char *name, int propid, prop_t value)
{
...
static void ml_paint(prop_t arg, primitive *self, rect *abspos, rect *upd)
{
#ifdef FLUX_EDM
