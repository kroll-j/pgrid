...
typedef void (*cb_paint)(prop_t arg, struct primitive *self, rect *abspos, rect *upd);
...
dword create_text(dword parent, int x,int y, int width,int height, char *text, int col, font *fnt, int align= 0);
...
dword clone_group(char *name, dword hparent, int x= 0, int y= 0,
