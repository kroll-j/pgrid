...
prop_t hscrlbox_cbprops(prop_t arg, struct primitive *self,
                     int type, char *name, int id, prop_t value)
{
  switch(type)
  {
//    case PROP_ADD:
...
int dd_cbstatus(prop_t arg, struct primitive *self, int type)
{
    switch(type)
    {
	    ...
	    wnd_show(lst, false);
	    wnd_setprop(self->id, "list_id", lst);
...
prop_t dd_cbprops(prop_t arg, primitive *self, int type, char *name, int id, prop_t value)
{
  switch(type)
  {
    case PROP_ADD:
...
prop_t lbitem_cbprops(prop_t arg, primitive *self, int type, char *name, int id, prop_t value)
{
  switch(type)
  {
    case PROP_ADD:
...
prop_t lblist_cbprops(prop_t arg, primitive *self, int type, char *name, int id, prop_t value)
{
...
void create_dropdown_group()
{
  ...
  wnd_prop_add(idmain, "list_id", 0, PROP_DWORD);
...
prop_t listbox_cbprops(prop_t arg, primitive *self, int type, char *name, int id, prop_t value)
{
...
void create_list(dword idwnd, int y, char *title, void (*cb)(int, int),
                 char *item0, ...)
{
  dword tmp=
...
void video_dlg(dword parent)
{
  ...
  dword frame= clone_frame("titleframetitleframe", newwnd);
...
prop_t btn_cbprops(prop_t arg, primitive *self, int type, char *name, int id, prop_t value)
{
...
prop_t tooltip_cbprops(prop_t arg, primitive *self, int type, char *name, int id, prop_t value)
{
  switch(type)
  {
    case PROP_SET:
...
void create_checkbox_group()
{
    ...
    create_text(btn, 0,0,8,8, "\x87", COL_FRAMEHI, FONT_SYMBOL, ALIGN_HCENTER|ALIGN_VCENTER);	// btn
